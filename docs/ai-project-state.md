...
**Last reconciled:** 5 July 2026 (v3 rejected by Johnson as worse than v2 — reverted; v2 (`mog2_fusion_comparison_v2.csv`, persistence + hold/decay, no proximity disambiguation) is the current working version; open question remains whether v2 falls back to cluster too often; see Ball tracker — MOG2-primary track section)
