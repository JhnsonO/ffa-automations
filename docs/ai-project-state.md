...
- **2026-07-04 (final):** Run `28699519056` verified — real duration 99.6s (moov header was misleading at 482s). Single wide→follow transition only; follow→wide→follow not proven on this clip. No snap/lag defects found. Next: need a source with a genuine second stoppage to complete the validation goal.
