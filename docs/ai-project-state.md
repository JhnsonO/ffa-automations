...
**Last reconciled:** 5 July 2026 (v1 render's stuck-looking run traced to a real logging gap in playcam-poc.yml + wide_safety_camera.py, both fixed; v2 fusion render redispatched with live progress as run `28754634376`, DISPATCHED/UNVERIFIED; see Ball tracker — MOG2-primary track section)
