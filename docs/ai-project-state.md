...
**Last reconciled:** 5 July 2026 (MOG2-fusion CSV built + committed from real data; real 2-minute render dispatched as run `28747766784`, DISPATCHED/UNVERIFIED; see Ball tracker — MOG2-primary track section)
