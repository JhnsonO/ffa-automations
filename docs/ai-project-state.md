...
**Last reconciled:** 5 July 2026 (goal confirmed real at t≈59s, far-left/off-centre; diagnosed pendulum/lag as v1 fusion CSV's lack of smoothing; built + dispatched v2 fusion CSV with persistence-gating and hold-then-decay, run `28752074401` DISPATCHED/UNVERIFIED; see Ball tracker — MOG2-primary track section)
