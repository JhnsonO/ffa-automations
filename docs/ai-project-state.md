...
**Last reconciled:** 5 July 2026 (diagnosed and quantified v2's ambiguous-frame rejection + false-persistence bugs from a real t≈48-50s failure; built v3 with proximity-based disambiguation + consistency-gated persistence; dispatched as run `28772842113`, DISPATCHED/UNVERIFIED; real tradeoff flagged — MOG2 usage dropped ~49.6%→18.75%, needs Johnson's visual call; see Ball tracker — MOG2-primary track section)
