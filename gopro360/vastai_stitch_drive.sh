...
[0:v:0]crop=624:1344:x=0:y=0,format=yuvj420p[left],\
[0:v:0]crop=624:1344:x=752:y=0,format=yuvj420p[right],\
[0:v:0]crop=64:1344:x=624:y=0,format=yuvj420p[segA],\
[0:v:0]crop=64:1344:x=688:y=0,format=yuvj420p[segB],\
...
[0:v:0]crop=1344:1344:1376:0[middle],\
[0:v:0]crop=624:1344:x=2720:y=0,format=yuvj420p[lRB],\
[0:v:0]crop=624:1344:x=3472:y=0,format=yuvj420p[rRB],\
[0:v:0]crop=64:1344:x=3344:y=0,format=yuvj420p[segARB],\
[0:v:0]crop=64:1344:x=3408:y=0,format=yuvj420p[segBRB],\
...
[0:v:1]crop=624:1344:x=0:y=0,format=yuvj420p[flt],\
[0:v:1]crop=624:1344:x=752:y=0,format=yuvj420p[frt],\
[0:v:1]crop=64:1344:x=624:y=0,format=yuvj420p[segC],\
[0:v:1]crop=64:1344:x=688:y=0,format=yuvj420p[segD],\
[segC][segD][mask3]maskedmerge[ltc],\
[ltc]scale=96:1344[ltcScaled],\
[flt][ltcScaled]hstack[tlh],[tlh][frt]hstack[tlDone],\
[0:v:1]crop=1344:1344:1376:0[tMid],\
[0:v:1]crop=624:1344:x=2720:y=0,format=yuvj420p[tlRB],\
[0:v:1]crop=624:1344:x=3472:y=0,format=yuvj420p[trRB],\
[0:v:1]crop=64:1344:x=3344:y=0,format=yuvj420p[segE],\
[0:v:1]crop=64:1344:x=3408:y=0,format=yuvj420p[segF],\
